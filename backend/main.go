...
import (
	...
	"log"
	"net/http"
	"portfolio/saborie/backend/controllers"
)
...
func main() {
	...
	router.HandleFunc(prefix+"/sabotas/me", userController.TokenVerifyMiddleware(sabotaController.MySabotas())).Methods("GET") // 認証必要
